...
private:
   ...
   */
  static INLINE double O3 fast_pow_10(int exp)
  {
   ...
   */
  static INLINE double O3 fast_log_10(double value)
  {
   ...
   */
  template <typename T>
  static INLINE int O3 format_as_bin(char* buffer, T value, uint32_t buf_size)
  {
   ...
   */
  template <typename T>
  static INLINE int O3 format_as_oct(char* buffer, T value, uint32_t buf_size, bool add_prefix = false)
  {
    static_assert(std::is_integral<T>::value, "T must be integral type");
  ...
  static INLINE int O3 format_as_dec(char* buffer, T value, uint32_t buf_size)
  {
   ...
   */
  template <typename T>
  static INLINE int O3 format_as_hex(char* buffer, T value, uint32_t buf_size, bool uppercase = false, bool add_prefix = false)
  {
    static_assert(std::is_integral<T>::value, "T must be integral type");
   ...
   */
  template <typename T>
  static INLINE int O3 format_as_basis(char* buffer, T value, int base, uint32_t buf_size)
  {
    static_assert(std::is_integral<T>::value, "T must be integral type");
   ...
   */
  template <typename T>
  static INLINE bool O3 should_use_scientific(T value, int precision)
  {
    if (value == 0.0)
    {
      return false;
   ...
   */
  template <typename T>
  static INLINE int O3 format_as_scientific(char* buffer, T value, int precision, uint32_t buf_size)
  {
   ...
   */
  template <typename T>
  static INLINE int O3 format_as_fraction(char* buffer, T value, int precision, uint32_t buf_size, bool use_scientific = false)
  {
    static_assert(std::is_floating_point<T>::value, "T must be a floating point type");
...
public:
   ...
   */
  template <typename T>
  static INLINE int O3 format(char* buffer, uint32_t buf_size, T value, int base = 10, bool uppercase = false, bool add_prefix = false)
  {
    static_assert(std::is_integral<T>::value, "T must be integral type");
   ...
   * @return int              格式化后的长度
   */
  static INLINE int O3 format(char* buffer, uint32_t buf_size, float value, int precision = 6, bool use_scientific = false)
  {
   ...
   * @return int              格式化后的长度
   */
  static INLINE int O3 format(char* buffer, uint32_t buf_size, double value, int precision = 6, bool use_scientific = false)
  {
