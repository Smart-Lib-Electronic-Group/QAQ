...
#define LX_NOR_QSPI_DRIVER
  ...
  extern UCHAR lx_stm32_nor_custom_extended_cache_memory[LX_STM32_CUSTOM_OBSOLETE_COUNT_CACHE_SIZE + LX_STM32_CUSTOM_MAPPING_BITMAP_CACHE_SIZE];
    #define LX_NOR_CUSTOM_DRIVERS { .name = "NOR CUSTOM DRIVER", .id = CUSTOM_DRIVER_ID, .nor_driver_initialize = lx_stm32_nor_custom_driver_initialize, .extended_nor_cache = lx_stm32_nor_custom_extended_cache_memory, .extended_nor_cache_size = sizeof(lx_stm32_nor_custom_extended_cache_memory) }
  #else
