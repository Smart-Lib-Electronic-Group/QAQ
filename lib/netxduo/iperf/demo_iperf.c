...
extern VOID nx_stm32_eth_driver(NX_IP_DRIVER*);
...
void tx_application_define(void* first_unused_memory)
{
  ...
  status  = nx_packet_pool_create(&pool_0, "NetX Main Packet Pool", (1536 + sizeof(NX_PACKET)), pointer, NX_PACKET_POOL_SIZE);
  ...
  status  = nx_ip_create(&ip_0, "NetX IP Instance 0", IP_ADDRESS(192, 168, 11, 10), 0xFFFFFF00UL, &pool_0, nx_stm32_eth_driver, pointer, 2048, 1);
